#!/usr/bin/env bash
# run_real.sh — GOM tat ca lenh chay GoVoice (mic ROBOT, PUSH-TO-TALK) vao 1 file.
# ⚠️ ROBOT CU DONG THAT (--real). Chi chay khi da san sang an toan:
#   - Vung trong quanh robot >= 2x2m
#   - Co nguoi cam remote (L2+B = dung khan cap)
#   - Pin >= 60%
#   - Da tat app Unitree tren dien thoai
#
# Chay:  ./run_real.sh
# Thoat: bam 'q' trong man PTT, hoac Ctrl+C bat ky luc nao — tu dong dep het
#        cac dich vu nen (llama-server, loa robot, mic robot) VA dung robot lai.
...
echo "===================================================="
echo " GoVoice — CHE DO THAT (--real, ROBOT SE CU DONG)"
echo "===================================================="
echo "⚠️  Xac nhan: vung trong >=2x2m, co nguoi cam remote,"
echo "    pin >=60%, da tat app Unitree tren dien thoai."
read -p "    Go Enter de tiep tuc, Ctrl+C de huy... "
...
echo " Noi 'dung lai' bat ky luc nao = phanh khan cap."
echo "===================================================="
